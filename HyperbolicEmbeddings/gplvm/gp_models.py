...
"""
Only line 331 was changed from the original gpytorch implementation 
batch_shape = full_output.batch_shape
to
batch_shape = full_output.batch_shape if hasattr(self, 'batch_params') and self.batch_params \
    else torch.Size([self.train_targets.shape[0]]) 
to support shared kernels for multitask learning
"""
...
class ExactGP(GP):
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Posterior mode
            ...
            batch_shape = full_output.batch_shape if hasattr(self, 'batch_params') and self.batch_params \
                else torch.Size([self.train_targets.shape[0]])  # This line has been updated to deal with shared kernels
